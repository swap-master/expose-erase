...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xview', part='eval'):
    ...
    for filename in os.listdir(data_path):
        ...
        action_class -= 60
        if subject_id == 6 or subject_id == 8 or subject_id == 11:
            continue
        else:
            subject_id -= 40
        ...
        if benchmark == 'xview':
            ...
            istraining = (replication_number in training_replication)
        elif benchmark == 'xrep_v2':
            istraining = (action_class % 2) == ((subject_id - replication_number) % 2)
        else:
            raise ValueError()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../data/nturgbd120star_raw')
    parser.add_argument('--ignored_sample_path',
                        default='../data/NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../data/ntu120disjoint/')
